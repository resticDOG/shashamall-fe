/*
* @Author: linkzz
* @Date:   2019-01-22 15:34:15
* @Last Modified by:   linkzz
* @Last Modified time: 2019-01-22 15:56:22
*/
var _cities = {
    cityInfo :  {
        '北京': ['北京'],
    ...
    /**
     * 获取所有省份集合
     * @return {Array} 返回cityInfo的键名数组即所有省份的数组
     */
    getProvinces : function(){
        var provinces = [];
        // 这里遍历对象可以用for...in...但是遍历数组不能用for...in...
    ...
    /**
     * 根据传入的省份获取该省份对应的城市集合
     * @param  {String} province 需要查找的省份
     * @return {Array}  该省份对应的城市数组,若找不到返回空数组
     */
